...
function Profile() {
    ...
    <motion.div  variants={containerVariants}
       className=" col-span-4">
        <div className="flex flex-col justify-center place-items-center gap-5 py-7 text-white bg-[#1c1c1c] rounded-2xl min-w-[100%] wh font-bold text-lg text-gray  border border-[#363636]  min-h-[20em] ">
